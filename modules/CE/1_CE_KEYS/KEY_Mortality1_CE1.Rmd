...
1. A=1-e<sup>-Z</sup>=1-e<sup>-`sum1w["Z","Estimate"]`</sup>=`1-exp(-sum1w["Z","Estimate"])`
...
1. A=1-e<sup>-Z</sup>=1-e<sup>-`sum2w["Z","Estimate"]`</sup>=`1-exp(-sum2w["Z","Estimate"])`
...
1. A=1-e<sup>-Z</sup>=1-e<sup>-`sum3w["Z","Estimate"]`</sup>=`1-exp(-sum3w["Z","Estimate"])`
...
1. A=1-e<sup>-Z</sup>=1-e<sup>-`sum4w["Z","Estimate"]`</sup>=`1-exp(-sum4w["Z","Estimate"])`

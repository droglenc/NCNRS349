...
1. The equation for the density independent model is R=`r formatC(coef(srI)[["a"]],format="f",digits=3)`S. The equation for the Ricker model is R=`r formatC(coef(srR)[["a"]],format="f",digits=3)`S*exp(-`r formatC(coef(srR)[["b"]],format="f",digits=3)`S).

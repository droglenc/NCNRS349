...
modHTML("Depletion-BKG",need2render=FALSE)
if (require(FSA)) purl2("Depletion-BKG.Rmd",topnotes="User must set working directory appropriately.")
```
...
reproInfo(rqrdPkgs=rqrd,out="markdown",links=c(Script="Depletion-BKG.R",RMarkdown="Depletion-BKG.Rmd"))
```

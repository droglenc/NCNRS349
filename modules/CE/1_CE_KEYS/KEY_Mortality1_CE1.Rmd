...
```{r KBLT, echo=FALSE, results="hide", message=FALSE, fig.show="hide"}
library(FSA)
library(tidyverse)
library(ggplot2)
...
1. Difficult to tell as the CI for 1954 captures the estimated value from 1967 but the opposite is not true. Would be best to perform an IVR with both sets of data.

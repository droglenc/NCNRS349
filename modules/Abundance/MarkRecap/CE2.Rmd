...
Describe the shape of the sampling distribution of the population estimate, bias percentage, and width of the approximate confidence interval for each combination of the expected number of marks and the expected number of in the second sample between 100 and 400 in increments of 50.  Each simulation below should be based on a known population size of `N=1000` individuals (the default), use at least `rsmpls=2000` simulation runs (the default), and use the Chapman modification method.  Use your results to answer the questions below.  [**Hint: You might want to make a two-way table to record your observations.**]

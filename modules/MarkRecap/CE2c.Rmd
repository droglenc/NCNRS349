...
The `mrClosed1Sim()` function in the `FSAsim` package was introduced on the [first page of this exercise](CE2.html).  That function can also be used to assess assumption violations by including the `sim="assumptions"` argument.

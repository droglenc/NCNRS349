...
\hline\hline
Indiv & Age & Length & Avg Age & Avg Length \\ 
\hline
1 & 1 & 248 & 1 & 248.0 \\ 
2 & 2 & 210 & 2 & 248.4 \\ 
3 & 2 & 225 & 3 & 281.8 \\ 
...
There are many versions or parameterizations of the VBGF (see [this section](#other-parameterizations-of-the-vbgf)).  The most common version is due to @Beverton1954} and  @BevertonHolt1957, who modified the original version introduced by von Bertalanffy [@Cailletetal2006].  This model will be termed the "typical" version of the VBGF throughout this vignetted.  The typical VBGF is represented by[^2]

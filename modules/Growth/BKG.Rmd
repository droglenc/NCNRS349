...
\indent to notice that the units in the numerator disappear.  Thus, the units of $K$ are in $time^{-1}$ rather than a change in length for a unit time as required by a growth rate.

...
1. The estimated recruitment at the mean stock level of 1178 fish is `r formatC(predMeanI,format="f",digits=0)` for the independence model and `r formatC(predMeanR[["Estimate"]],format="f",digits=0)` for the Ricker model.

...
1. How does the descending limb of the catch curve change (relative to the catch curve at the default values) in each situation below.  Convince yourself that your observations make biological sense.
    1. Increase mean $Z$.
    1. Decrease mean $Z$.

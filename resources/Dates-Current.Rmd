...
setwd("C:/aaaWork/Web/GitHub/NCNRS349/resources/")
...
d <- readxl::read_excel("Dates_349.xlsx",sheet="W22") %>%
...
if (nrow(dfuture)>0) {
  ## Put a blank row after each Thursday
  blank_rows <- grep("Thu",dfuture$Date)

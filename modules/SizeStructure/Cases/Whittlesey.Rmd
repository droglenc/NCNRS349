...
* You should open the Excel file described above and save `Sheet1` as a CSV file.  Then create a script that reads the CSV file into an object in R and displays the structure and a random six rows of the data.frame.

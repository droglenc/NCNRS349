...
```{r setup, echo=-(1:2), results='hide', message=FALSE, warning=FALSE}
...
```{r RickerMultFit, echo=FALSE, results='hide', warning=FALSE}
...
1. There relationship between the abundance of age-0 and age-5 fish is weak at best (see figure further below). I do not expect the Ricker stock-recruitment model to fit well.
1. The equation for the density independent model is R=`r coef(srI)[["a"]]`S. The equation for the Ricker model is R=`r coef(srR)[["a"]]`S*exp(-`r coef(srR)[["b"]]`S).
